  ...
  <div class="navbar">
    ...
    <div class="navbar-right-container" style="display: flex;">
      <div class="navbar-menu-container">
        ...
        <a href="javascript:void(0)" class="navbar-link" v-show="this.Login!='Login'">Logout</a>
...
<!-- 登陆 -->
  ...
  <div class="md-modal-inner">
    <div class="md-top"><div class="md-title" @click="loginModalFlag=true">Login in</div> 
    <button class="md-close" @click="loginModalFlag=false">Close</button></div>
     <div class="md-content"><div class="confirm-tips">
       <div class="error-wrap"><span class="error error-show" v-show="errorTip"></span></div> 
       <ul><li class="regi_form_input">
         ...
         <li class="regi_form_input noMargin"><i class="icon IconPwd"></i> <input type="password" tabindex="2" name="password" placeholder="Password" class="regi_login_input regi_login_input_left login-input-no input_text" v-model="userPwd"></li>
         </ul>
         </div> 
    ...
    login(){
      axios.post("/users/login",{
        ...
        if(res.status=="0"){
          ...
          this.Login=res.result.userName;
        }else{
        this.errorTip=true;
        }
      })
